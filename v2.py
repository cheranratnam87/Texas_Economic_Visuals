...
@st.cache_data
def load_data():
    url = "https://raw.githubusercontent.com/cheranratnam87/Texas_Economic_Visuals/refs/heads/main/Key_Economic_Indicators_20250309.csv"
    dtype_dict = {
        "year": "int16", 
        "month": "int8", 
        "unemployment_tx": "float32",  # Adjust other column types accordingly
    }
